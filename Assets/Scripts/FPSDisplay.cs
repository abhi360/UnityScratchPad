...
public class FPSDisplay : MonoBehaviour
{
	...
	void Update () {
		highestFPSLabel.text = fpsCounter.HighestFPS.ToStringLookup ();

		averageFPSLabel.text = fpsCounter.AverageFPS.ToStringLookup();

		lowestFPSLabel.text = fpsCounter.LowestFPS.ToStringLookup ();
	}
}
...
public static class ToStringExtensions
{
	...
	public static string ToStringLookup(this int value)
	{
		...
		return _cache[Mathf.Clamp(value, 0, _top)];
	}
}
